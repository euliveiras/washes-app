...
// node_modules/@chakra-ui/react-utils/dist/index.mjs
init_global();
init_dirname();
init_filename();
init_buffer();
...
var env = typeof process_exports === "undefined" || process_exports.env === void 0 ? defaultEnvironment : "development";
...
function ButtonIcon(props) {
  ...
  const _children = (0, import_react58.isValidElement)(children) ? (0, import_react58.cloneElement)(children, {
    "aria-hidden": true,
    focusable: false
  }) : children;
...
function ButtonSpinner(props) {
  ...
  const spinnerStyles = (0, import_react59.useMemo)(
    () => ({
      display: "flex",
      alignItems: "center",
...
function useMergeRefs(...refs) {
  return (0, import_react60.useMemo)(() => mergeRefs(...refs), refs);
}
...
var Button = forwardRef((props, ref) => {
  ...
  const buttonStyles = (0, import_react61.useMemo)(() => {
